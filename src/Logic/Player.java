...
public class Player implements GameObject, VisibleObject, MovableObject, ColliderObject {
    public String name;
    public int lives;
    ...
    public int RTWX;
    public int RTWY;
    public Form form = Form.valueOf("Player");
    ...
    @Override
    public void move() {
        this.setRTWX(this.getVelocity().getPathX());
        this.setRTWY(this.getVelocity().getPathY());
        //
